...
export type HealthMetricCategory = 'sleep' | 'recovery' | 'movement' | 'oxygen' | 'activity';
export type HealthMetricDirection = 'more-better' | 'less-better' | 'neutral';
export type HealthSummaryTone = 'good' | 'warning' | 'neutral';
